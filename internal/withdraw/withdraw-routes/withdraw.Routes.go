...
func Withdrawroutes(App *fiber.App, redisClient *redis.Client, newMongoDB *mongo.Client) {
	...
	App.Post("/Withdraw/WithdrawalRequest", middleware.UseExtractor(), middleware.TOTPAuthMiddleware(withdrawRepository), withdrawHandler.WithdrawalRequest)
	...
	App.Get("/Withdraw/GetWithdrawalToken", middleware.UseExtractor(), withdrawHandler.GetWithdrawalToken)
}
